...
public final class JSONResponses {
    ...
    public static final JSONStreamAware MISSING_PENDING_MAX_HEIGHT = missing("pendingMaxHeight");
    public static final JSONStreamAware MISSING_PENDING_QUORUM = missing("pendingQuorum");
    public static final JSONStreamAware INCORRECT_PENDING_VOTING_MODEL = incorrect("pendingVotingModel");
    public static final JSONStreamAware INCORRECT_PENDING_ASSET_ID = incorrect("pendingAssetId");
    public static final JSONStreamAware INCORRECT_PENDING_WHITELIST = incorrect("pendingWhitelisted");
    public static final JSONStreamAware INCORRECT_PENDING_MIN_BALANCE = incorrect("pendingMinBalance");
    ...
    public static final JSONStreamAware INCORRECT_PENDING_QUORUM = incorrect("pendingQuorum");
    public static final JSONStreamAware INCORRECT_PENDING_MAX_HEIGHT = incorrect("pendingMaxHeight");
    public static final JSONStreamAware MISSING_PENDING_VOTING_MODEL = missing("pendingVotingModel");
    public static final JSONStreamAware MISSING_PENDING_ASSET_ID = missing("pendingAssetId");
    public static final JSONStreamAware MISSING_PENDING_WHITELIST = missing("pendingWhitelisted");
    public static final JSONStreamAware MISSING_PENDING_BLACKLIST = missing("pendingBlacklisted");
