...
public final class JSONResponses {
    ...
    public static final JSONStreamAware MISSING_HEIGHT_TO_RELEASE = missing("heightToRelease");
    public static final JSONStreamAware MISSING_VOTE_THRESHOLD = missing("voteThreshold");
    public static final JSONStreamAware MISSING_QUORUM = missing("quorum");
    public static final JSONStreamAware INCORRECT_PENGING_TX_VOTING_MODEL = incorrect("pendingTxVotingModel");
    public static final JSONStreamAware INCORRECT_PENDING_TX_ASSET_ID = incorrect("pendingTxAssetId");
    public static final JSONStreamAware INCORRECT_WHITELIST = incorrect("whitelist");
    public static final JSONStreamAware INCORRECT_VOTE_THRESHOLD = incorrect("voteThreshold");
    public static final JSONStreamAware INCORRECT_BLACKLIST = incorrect("blacklist");
    public static final JSONStreamAware INCORRECT_DEADLINE = incorrect("deadline");
    public static final JSONStreamAware INCORRECT_QUORUM = incorrect("quorum");
    public static final JSONStreamAware INCORRECT_HEIGHT_TO_RELEASE = incorrect("heightToRelease");
    public static final JSONStreamAware MISSING_PENGING_TX_VOTING_MODEL = missing("pendingTxVotingModel");
    public static final JSONStreamAware MISSING_PENDING_TX_ASSET_ID = missing("pendingTxAssetId");
    public static final JSONStreamAware MISSING_WHITELIST = missing("whitelist");
    public static final JSONStreamAware MISSING_BLACKLIST = missing("blacklist");
