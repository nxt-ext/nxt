...
public final class GetConstants extends APIServlet.APIRequestHandler {
    ...
    static {
        ...
        transactionTypes.add(transactionType);
        transactionType = new JSONObject();
        transactionType.put("value", TransactionType.MonetarySystem.CURRENCY_ISSUANCE.getType());
        transactionType.put("description", "Monetary System");
        subtypes = new JSONArray();
        subtype = new JSONObject();
        subtype.put("value", TransactionType.MonetarySystem.CURRENCY_ISSUANCE.getSubtype());
        subtype.put("description", "Currency issuance");
        subtypes.add(subtype);
        subtype = new JSONObject();
        subtype.put("value", TransactionType.MonetarySystem.RESERVE_INCREASE.getSubtype());
        subtype.put("description", "Reserve increase");
        subtypes.add(subtype);
        subtype = new JSONObject();
        subtype.put("value", TransactionType.MonetarySystem.RESERVE_CLAIM.getSubtype());
        subtype.put("description", "Reserve claim");
        subtypes.add(subtype);
        subtype = new JSONObject();
        subtype.put("value", TransactionType.MonetarySystem.MONEY_TRANSFER.getSubtype());
        subtype.put("description", "Money transfer");
        subtypes.add(subtype);
        subtype = new JSONObject();
        subtype.put("value", TransactionType.MonetarySystem.EXCHANGE_OFFER_PUBLICATION.getSubtype());
        subtype.put("description", "Exchange offer publication");
        subtypes.add(subtype);
        subtype = new JSONObject();
        subtype.put("value", TransactionType.MonetarySystem.EXCHANGE.getSubtype());
        subtype.put("description", "Exchange");
        subtypes.add(subtype);
        subtype = new JSONObject();
        subtype.put("value", TransactionType.MonetarySystem.MONEY_MINTING.getSubtype());
        subtype.put("description", "Money minting");
        subtypes.add(subtype);
        subtype = new JSONObject();
        subtype.put("value", TransactionType.MonetarySystem.SHUFFLING_INITIATION.getSubtype());
        subtype.put("description", "Shuffling initiation");
        subtypes.add(subtype);
        subtype = new JSONObject();
        subtype.put("value", TransactionType.MonetarySystem.SHUFFLING_CONTINUATION.getSubtype());
        subtype.put("description", "Shuffling continuation");
        subtypes.add(subtype);
        subtype = new JSONObject();
        subtype.put("value", TransactionType.MonetarySystem.SHUFFLING_FINALIZATION.getSubtype());
        subtype.put("description", "Shuffling finalization");
        subtypes.add(subtype);
        subtype = new JSONObject();
        subtype.put("value", TransactionType.MonetarySystem.SHUFFLING_CANCELLATION.getSubtype());
