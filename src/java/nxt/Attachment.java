...
public interface Attachment extends Appendix {
    ...
    public final static class MonetarySystemCurrencyIssuance extends AbstractAttachment {
        ...
        MonetarySystemCurrencyIssuance(ByteBuffer buffer, byte transactionVersion) throws NxtException.ValidationException {
            super(buffer, transactionVersion);
        ...
        MonetarySystemCurrencyIssuance(JSONObject attachmentData) throws NxtException.ValidationException {
            super(attachmentData);
            this.name = (String)attachmentData.get("name");
    ...
    public final static class MonetarySystemMoneyTransfer extends AbstractAttachment {
        ...
        MonetarySystemMoneyTransfer(ByteBuffer buffer, byte transactionVersion) throws NxtException.ValidationException {
            super(buffer, transactionVersion);
