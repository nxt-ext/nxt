...
public interface Attachment extends Appendix {
    ...
    public final static class MonetarySystemShufflingInitiation extends AbstractAttachment {
        ...
        MonetarySystemShufflingInitiation(Long currencyId, long amount, byte numberOfParticipants, short maxInitiationDelay, short maxContinuationDelay, short maxFinalizationDelay) {
            this.currencyId = currencyId;
            this.amount = amount;
    ...
    public final static class MonetarySystemShufflingFinalization extends AbstractAttachment {
        ...
        MonetarySystemShufflingFinalization(Long[] recipients) {
            this.recipients = recipients;
        }
