...
public final class KNV {
    ...
    private static final long[] constants = {1L, 32898L, -9223372036854742902L, -9223372034707259392L, 32907L, 2147483649L, -9223372034707259263L, -9223372036854743031L, 138L, 136L, 2147516425L, 2147483658L, 2147516555L, -9223372036854775669L, -9223372036854742903L, -9223372036854743037L, -9223372036854743038L, -9223372036854775680L, 32778L, -9223372034707292150L, -9223372034707259263L, -9223372036854742912L, 2147483649L, -9223372034707259384L};

    // cfb: "inputLength" must be a multiple of 8
    public static void hash(byte input[], int inputOffset, int inputLength, byte output[], int outputOffset) {
        ...
        for (int i = 0; i < 32; i++) {
            ...
            output[outputOffset + i] = (byte)(state[i >> 3] >> ((i & 7) << 3));
